...
export const badgeVariants = tv({
    ...
    variants: {
        variant: {
            ...
            success: "bg-green-600 text-success-foreground hover:bg-green-600/80 border-transparent",
            warning: "bg-yellow-500 text-warning-foreground hover:bg-yellow-500/80 border-transparent",
        },
    },
    defaultVariants: {
        variant: "default",
